      ...
      <div className="post-modalContainer">
        <div className="post-first-layer">
          <button type="button" className="post-first-layer-button">
            ...
            <div className="post-first-layer-content">
              ...
              <svg
                className="post-first-layer-icon"
          ...
          <svg
            ...
            className="post-first-layer-cross-icon"
            xmlns="http://www.w3.org/2000/svg"
            width="21"
            height="21"
            viewBox="0 0 21 21"
        ...
        <div className="post-third-layer">
          ...
          <div className="post-third-layer-container">
            <p
              style={{
                display: buttonToggle === "photo" ? "block" : "none",
                left: leftValue,
              }}
            >
              Add a photo
            ...
            <p
              style={{
                display: buttonToggle === "video" ? "block" : "none",
                left: leftValue,
              }}
            >
              Add a video
            ...
            <p
              style={{
                display: buttonToggle === "event" ? "block" : "none",
                left: leftValue,
              }}
            >
              Create an event
            ...
            {moreoptions ? (
              <div className="post-third-layer-additional-container">
                <p
                  style={{
                    display: buttonToggle === "occasion" ? "block" : "none",
                    left: leftValue,
                  }}
                >
                ...
                <p
                  style={{
                    display: buttonToggle === "hiring" ? "block" : "none",
                    left: leftValue,
                  }}
                >
                ...
                <p
                  style={{
                    display: buttonToggle === "poll" ? "block" : "none",
                    left: leftValue,
                  }}
                >
                  Create a poll
                ...
                <p
                  style={{
                    display: buttonToggle === "document" ? "block" : "none",
                    left: leftValue,
                  }}
                >
                  Add a document
                ...
                <p
                  style={{
                    display: buttonToggle === "expert" ? "block" : "none",
                    left: leftValue,
                  }}
                >
                  Find an expert
              ...
              <p
                style={{
                  display: buttonToggle === "more" ? "block" : "none",
                  left: leftValue,
                }}
              >
                More
          ...
          <div className="post-third-layer-container">
            <button
              onMouseOverCapture={() => {
                setButtonToggle("photo");
                setLeftValue(5);
              }}
              onMouseOutCapture={() => setButtonToggle("")}
              type="button"
              aria-label="Picture"
            >
              <svg
            ...
            >
              ...
              >
                <path
                  fill="rgba(0, 0, 0, 0.6)"
                  d="M7 11h2v2H7v-2m14-6v14c0 1.11-.89 2-2 2H5a2 2 0 0 1-2-2V5c0-1.1.9-2 2-2h1V1h2v2h8V1h2v2h1a2 2 0 0 1 2 2M5 7h14V5H5v2m14 12V9H5v10h14m-4-6h2v-2h-2v2m-4 0h2v-2h-2v2Z"
                />
              </svg>
            </button>
            {moreoptions ? (
              <div className="post-third-layer-additional-container">
                ...
                >
                  ...
                  >
                    <path
                      fill="rgba(0, 0, 0, 0.6)"
                      d="M20 2H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h4l4 4l4-4h4a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2m-8 2.3c1.5 0 2.7 1.2 2.7 2.7c0 1.5-1.2 2.7-2.7 2.7c-1.5 0-2.7-1.2-2.7-2.7c0-1.5 1.2-2.7 2.7-2.7M18 15H6v-.9c0-2 4-3.1 6-3.1s6 1.1 6 3.1v.9Z"
                    />
                  </svg>
                </button>
              </div>
        ...
        <div className="post-last-layer">
          ...
          <p
            style={{
              display: buttonToggle === "schedule" ? "block" : "none",
              top: "-20px",
              right: leftValue,
            }}
          >
          ...
          <button className="post-btn" type="button" aria-label="Post">
            Post
          </button>
        </div>
      </div>
